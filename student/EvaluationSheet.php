...
session_start();
	...
	//replace true
	//check user_id and user type include evaluation id
	if(false  ){
...
<body>
		...
		<div class="row col-md-8" style="background-color: #d3ffd3;">
				...
				<div>
					...
					<form method="post" action="FetchRating.php">
					...
					<br>
					<div align="right">
					<button type="submit" class="btn btn-primary"><i class="fa fa-share"> Submit</i></button>
					<button type="submit" class="btn btn-danger"><i class="fa fa-share"> Cancel</i></button>
					</div>
